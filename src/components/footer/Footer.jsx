...
const Footer = () => {
  return ( 
    <>
          ...
          <section class="bg-iphone-black">
              <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                  <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                      <div class="px-5 py-2 ">
                          <a href="#" class="text-base leading-6 text-iphone-white hover:underline">
                              About
                          </a>
                      </div>
                      <div class="px-5 py-2">
                  ...
                  <div class="flex justify-center mt-8 space-x-6">
                      <a href="#" class="text-gray-400 hover:text-gray-500">
                          ...
                          <svg class="w-6 h-6 iphone-white " aria-hidden="true" fill="white" viewBox="0 0 24 24">
                  ...
                  <p class="mt-8 text-base leading-6  text-iphone-white hover:underline">
                      © 2024 sunilparajuli, Inc. All rights reserved.
                  </p>
              </div>
          </section>
